![docker image](https://github.com/nomad-hzb/hzb-se-image-2/actions/workflows/docker-publish.yml/badge.svg)
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/nomad-hzb/hzb-se-image-2.git
    cd hzb-se-image-2
    ```
    ...
    ```sh
    curl-L -o hzb-se-image-2.zip "https://github.com/nomad-hzb/hzb-se-image-2/archive/main.zip"
    unzip hzb-se-image-2.zip
    cd hzb-se-image-2
    ```
...
your `docker-compose.yaml` with `ghcr.io/nomad-hzb/hzb-se-image-2:main` for the services
...
```
docker pull ghcr.io/nomad-hzb/hzb-se-image-2/jupyter:main
```
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/nomad-hzb/hzb-se-image-2/manifests/main": unauthorized`
